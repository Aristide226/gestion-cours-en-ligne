...
<body>
    ...
    <form action="cours" method="post">
        ...
        <textarea id="description" 
                  name="description" 
                  rows="4" 
                  required>${cours.description}</textarea><br><br>

        <label for="niveau">Niveau :</label><br>
        <select id="niveau" name="niveau">
            <option value="Débutant" ${cours.niveau == 'Débutant' ? 'selected' : ''}>
                Débutant
            </option>
            <option value="Intermédiaire" ${cours.niveau == 'Intermédiaire' ? 'selected' : ''}>
                Intermédiaire
            </option>
            <option value="Avancé" ${cours.niveau == 'Avancé' ? 'selected' : ''}>
                Avancé
            </option>
        </select><br><br>
